...
useEffect(() => {
    ...
    return parts.map((part, i) => {
        if (part.match(urlRegex)) {
            return (
                <a key={i} href={part} target="_blank" rel="noopener noreferrer" className="text-[#ff6122] hover:underline font-bold break-all">
                    {part}
                </a>
            );
        }
        ...
        <div className="flex flex-col text-[#222] bg-[#F3F3F3] min-h-screen relative font-sans">
            ...
            <div className="max-w-6xl mx-auto w-full py-12 px-6">
                ...
                <div className="max-w-4xl mx-auto px-4 md:px-0 pb-20">
                    <div className="bg-white rounded-[32px] md:rounded-[40px] shadow-xl shadow-neutral-200/50 border border-neutral-100 overflow-hidden">
            
            {/* Header */}
            <div className="p-6 md:p-8 border-b border-neutral-50 bg-white flex justify-between items-center">
                <h3 className="text-lg font-black uppercase tracking-tighter">
                    Papan <span className="text-[#ff6122]">Percakapan</span>
                </h3>
                <span className="text-[10px] font-bold text-neutral-400 bg-neutral-100 px-3 py-1 rounded-full uppercase">
                    {conversations?.length || 0} Pesan
                </span>
            </div>
            ...
            <div className="p-6 md:p-10">
                ...
                <div className="relative mb-12 group">
                    {replyTo && (
                        <div className="mb-3 flex justify-between items-center bg-neutral-50 px-4 py-2 rounded-xl border-l-4 border-[#ff6122]">
                            <p className="text-[11px] text-neutral-500 font-medium">
                                Membalas <span className="font-bold text-neutral-800">@{replyTo.user.name}</span>
                            </p>
                            <button onClick={() => setReplyTo(null)} className="text-neutral-400 hover:text-red-500 transition">
                    ...
                    <textarea 
                        ...
                        className="w-full bg-neutral-50 border-2 border-neutral-100 rounded-[24px] md:rounded-[30px] p-6 text-sm focus:border-[#ff6122]/30 focus:bg-white focus:ring-0 transition-all min-h-[140px] resize-none"
                    />
                    <button 
                        onClick={handleSendMessage}
                        disabled={isSubmittingMessage || !conversationText.trim()}
                        className="absolute bottom-4 right-4 bg-[#ff6122] text-white px-6 md:px-8 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:translate-y-[-2px] active:scale-95 transition-all disabled:opacity-50 disabled:translate-y-0 shadow-lg shadow-[#ff6122]/30"
                    >
                            ...
                            <div key={msg.id} className="space-y-4">
                                ...
                                <div className="flex gap-4 group">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="bg-white border border-neutral-100 p-4 rounded-2xl rounded-tl-none shadow-sm group-hover:shadow-md transition-all">
                                            <p className="text-neutral-600 text-[14px]">{renderMessageWithLinks(msg.message)}</p>
                                        </div>
                                        <button onClick={() => setReplyTo(msg)} className="text-[10px] font-bold text-[#ff6122] mt-1 hover:underline ml-1">
                                            Balas
                                        </button>
                                    </div>
                                </div>
                                ...
                                {msg.replies && msg.replies.length > 0 && (
                                    <div className="ml-12 space-y-4 border-l-2 border-neutral-100 pl-4">
                                                ...
                                                <div className="flex-grow">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span className="text-[9px] text-neutral-400">
                                                            {reply.created_at ? formatDistanceToNow(new Date(reply.created_at), { addSuffix: true, locale: id }) : 'Baru saja'}
                                                        </span>
                                                    </div>
                                                    <div className="bg-neutral-50 p-3 rounded-xl rounded-tl-none border border-neutral-100">
